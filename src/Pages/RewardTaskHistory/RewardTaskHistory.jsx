    ...
    fetch('https://server.amazonkindlerating.com/user-tasks')
        ...
        .then((data) => {
            const targetTasks = data
                .filter((item) => item.product_id==="Reward Task")
                .sort((a, b) => {
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            <div className="text-sm space-y-1">
                                ...
                                <p><span className="font-semibold text-gray-700">🎯 Maximum Reward Point:</span> {task.maximumRewardPoint}</p>
...
export default RewardTaskHistory;
