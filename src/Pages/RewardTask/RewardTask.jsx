...
const RewardTask = ({ user, onClose }) => {
    ...
    const handleSaveTargetTask = () => {
        ...
        const addTargetTask = {
            ...
            maximumRewardPoint: parseInt(targetTaskNo),
    ...
    return (
        <div className="p-6 bg-gradient-to-b from-blue-100 to-white min-h-screen text-gray-800">
            <h2 className="text-2xl font-bold mb-4">Reward Task</h2>
            ...
            <div className="mb-6 space-y-2">
                ...
                <div><strong>Current Point:</strong> {user.redemPoint}</div>

                <div className="space-y-2">
                    <div>
                        <label className="font-semibold">Maximum Point</label>
                        <input
                            type="text"
                            value={targetTaskNo}
